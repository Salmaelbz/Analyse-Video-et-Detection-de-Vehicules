...
# Inversion du masque pour obtenir la partie non masquée (voitures)
masque_voitures_inverse = cv2.bitwise_not(masque_voitures)

# Application du masque inversé pour isoler la partie non masquée (voitures)
voitures_inversees = cv2.bitwise_and(fond_gris, fond_gris, mask=masque_voitures_inverse)
...
# Affichage de la partie non masquée (voitures inversées)
cv2.imshow('Voitures Inversees', voitures_inversees)
